        ...
        <div class="row row-cols-1">
            <div class="col">
                <div class="breadcrumb__content text-center">
                    <h1 class="breadcrumb__content--title text-white mb-25">Product Search</h1>
                    <ul class="breadcrumb__content--menu d-flex justify-content-center">
                        <li class="breadcrumb__content--menu__items"><a class="text-white" href="index.php">Home</a></li>
                        <li class="breadcrumb__content--menu__items"><span class="text-white">Search result</span></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="shop__product--wrapper">
                    <div class="tab_content">
                        ...
                        $size = $this->db->select('*')->from('size')->where('id',$variation[0]['size_id'])->get()->result_array();
                                    ?>
            <div class="col mb-30" >
                    <div class="product__items" style="border: 1px solid #6c0606; padding: 5px;">
                        ...
                        <div class="product__items--price">
                            ...
                            <ul class="product__items--action d-flex">
                                ...
                                <li class="product__items--action__list" style="background-color: #6c0606;">
                                ...
                                <li class="product__items--action__list" style="border: 1px solid #6c0606;">
                                    <a class="product__items--action__btn"  href="<?php echo base_url(); ?>Product/product_details/<?php echo $row['id']; ?>">
                                        <svg class="product__items--action__btn--svg" style="color: #6c0606; " xmlns="http://www.w3.org/2000/svg"  width="25.51" height="23.443" viewBox="0 0 512 512"><path d="M255.66 112c-77.94 0-157.89 45.11-220.83 135.33a16 16 0 00-.27 17.77C82.92 340.8 161.8 400 255.66 400c92.84 0 173.34-59.38 221.79-135.25a16.14 16.14 0 000-17.47C428.89 172.28 347.8 112 255.66 112z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="32"/><circle cx="256" cy="256" r="80" fill="none" stroke="currentColor" stroke-miterlimit="10" stroke-width="32"/></svg>
