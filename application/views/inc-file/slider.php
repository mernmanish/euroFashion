                                    ...
                                    <div class="row row-cols-1">
                                        <div class="col">
                                            <div class="slider__content">
                                                <p class="slider__content--desc desc1 mb-15"><img class="slider__text--shape__icon" src="<?php echo base_url(); ?>assets/img/icon/text-shape-icon.png" alt="text-shape-icon"> New Collection</p> 
                                                ...
                                                <a class="slider__btn primary__btn" href="<?php echo base_url(); ?>productlist.php">Show Collection
                                    ...
                                    <div class="col">
                                        <div class="hero__slider--items__inner">
                                            <div class="slider__content">
                                                ...
                                                <p class="slider__content--desc desc2 d-sm-2-none mb-40 ">Up To 40% Off Final Sale Items. <br>
                                                    Caught in the Moment!</p>    
                                                <a class="primary__btn slider__btn" href="<?php echo base_url(); ?>productlist.php">Show Collection
