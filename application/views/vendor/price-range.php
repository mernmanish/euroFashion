...
<div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Price Range List <a href="<?php echo base_url(); ?>branch/Product_Master/price_range?do=new" class="btn btn-success" style="float: right;">Add Price Range</a></h1>
                  ...
                  foreach($sqlcat as $rows)
                  {
                   ?>
                    <tr>
                      ...
                      <td>
		               <a  class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>branch/Product_Master/price_range?do=update&id=<?php echo $rows['id']; ?>"><i class="fa fa-pencil"></i></a>
		              <button class="btn btn-success btn-sm" id="<?php echo $rows['id']; ?>" onclick="deletecollegefee(this.id)"><i class="fa fa-trash"></i></button></td>
                    </tr>
                  <?php $i++; } ?>
                  </tbody>
                </table>
...
<?php else: ?>
	<div class="content-wrapper">
     <section class="content-header">
      <h1>Add/Update College Fee <a href="<?php echo base_url(); ?>branch/Product_Master/price_range" class="btn btn-success pull-right">College Fee List</a></h1>
    </section>
    <section class="content">
      <div class="container-fluid">
        <div class="row">
...
<script type="text/javascript">
  ...
  $("#feeform").validate({
    ...
    submitHandler: function() {
      ...
      $.ajax({
                url: '<?php echo base_url(); ?>branch/Product_Master/managepricerange', 
                type: 'POST',
                dataType: 'json', 
                data: formData,
                contentType: false,
  ...
  function deletecollegefee(id)
  {
    ...
    var formData={"id":id};
    $.ajax({
      url:'<?php echo base_url('branch/Product_Master/deletepricerange'); ?>',
      type:'POST',
      dataType:'json',
      data: formData,
