                  ...
                  foreach($sqlbrand as $rows)
                  {
                   ?>
                    <tr>
		              ...
		              <button class="btn btn-success btn-sm" id="<?php echo $rows['id']; ?>" onclick="deletebrand(this.id)"><i class="fa fa-trash"></i></button></td>
                    </tr>
                  <?php $i++; } ?>
                  </tbody>
                </table>
...
<script type="text/javascript">
    ...
    submitHandler: function() {
      ...
      $.ajax({
                url: '<?php echo base_url(); ?>branch/Product_Master/Manage_Brand', 
                type: 'POST',
                dataType: 'json', 
                data: formData,
                contentType: false,
  ...
  function deletebrand(id)
  {
    ...
    var formData={"id":id};
    $.ajax({
      url:'<?php echo base_url('branch/Product_Master/Delete_brand'); ?>',
      type:'POST',
      dataType:'json',
      data: formData,
  ...
  function editbrand(id)
  {
    ...
    $.ajax({
      type:'POST',
      url:'<?php echo base_url('branch/Product_Master/Edit_brand'); ?>',
      dataType:'json',
      data:formData,
      success:function(data){
        //alert(resp);
