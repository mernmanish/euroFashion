              ...
              <div class="card-body">
                ...
                <table class="table table-bordered" id="table">
                 ...
                 ?>
                    ...
                    <td>
                      <a  class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>vendor/Order/change_order?do=update&id=<?php echo $rows['id']; ?>"><i class="fa fa-pencil"></i></a>
...
<?php else: ?>
	<div class="content-wrapper">
     <section class="content-header">
      <h1>Add/Update Orders <a href="<?php echo base_url(); ?>vendor/Order/change_order" class="btn btn-primary pull-right">Orders List</a></h1>
    </section>
    <section class="content">
      <div class="container-fluid">
        <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <select class="form-control select2" name="cust_id" id="cust_id" onchange="changecustomer();">
                      ...
                      <?php
                      $sql=$this->db->select('*')->from('customer')->where('vendor_id',$this->session->userdata('sessionuser')['userid'])->order_by('cust_name','asc')->get()->result_array();
                      foreach($sql as $rows)
                      {
                      ?>
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <select class="form-control" id="state_id" name="state_id">
                      ...
                      <?php
                      $sql=$this->db->select('*')->from('state')->where('vendor_id',$this->session->userdata('sessionuser')['userid'])->order_by('name','asc')->get()->result_array();
                      foreach($sql as $rows)
                      { 
                      ?>
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <select class="form-control" id="city_id" name="city_id">
                      ...
                      <?php
                      $sql=$this->db->select('*')->from('city')->where('vendor_id',$this->session->userdata('sessionuser')['userid'])->order_by('name','asc')->get()->result_array();
                      foreach($sql as $rows)
                      { 
                      ?>
                          ...
                          <tr>
                            <td>
                              <select class="form-control select2 product_key" name="pro_id[]" id="pro_id">
                               ...
                               <?php 
                               $sqlpro=$this->db->select('*')->from('product')->where('vendor_id',$this->session->userdata('sessionuser')['userid'])->get()->result_array();
...
<script type="text/javascript">
   $(document).ready(function(){
    ...
    submitHandler: function() {
      ...
      $.ajax({
                url: '<?php echo base_url(); ?>vendor/Order/changeorder', 
                type: 'POST',
                dataType: 'json', 
                data: formData,
                contentType: false,
...
<script type="text/javascript">
  function changecustomer()
  {
    ...
    $.ajax({
      type:'POST',
      url:'<?php echo base_url('vendor/Order/change_customermobile'); ?>',
      dataType:'json',
      data:formData,
