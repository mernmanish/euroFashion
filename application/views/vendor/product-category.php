                  ...
                  foreach($sqlbrand as $rows)
                  {
                   ?>
                    ...
                    <?php } ?>
		              ...
		              <button class="btn btn-success btn-sm" id="<?php echo $rows['id']; ?>" onclick="deletecategory(this.id)"><i class="fa fa-trash"></i></button></td>
                    </tr>
                  <?php $i++; } ?>
                  </tbody>
                </table>
...
<script type="text/javascript">
    ...
    submitHandler: function() {
      ...
      $.ajax({
                url: '<?php echo base_url(); ?>branch/Product_Master/add_category', 
                type: 'POST',
                dataType: 'json', 
                data: formData,
                contentType: false,
  ...
  function deletecategory(id)
  {
    ...
    var formData={"id":id};
    $.ajax({
      url:'<?php echo base_url('branch/Product_Master/Delete_category'); ?>',
      type:'POST',
      dataType:'json',
      data: formData,
  ...
  function editcategory(id)
  {
    ...
    $.ajax({
      type:'POST',
      url:'<?php echo base_url('branch/Product_Master/Edit_category'); ?>',
      dataType:'json',
      data:formData,
      success:function(data){
        //alert(resp);
