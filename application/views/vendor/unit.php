                  ...
                  foreach($sqlunit as $rows)
                  {
                   ?>
                    <tr>
		              ...
		              <button class="btn btn-success btn-sm" id="<?php echo $rows['id']; ?>" onclick="deleteunit(this.id)"><i class="fa fa-trash"></i></button></td>
                    </tr>
                  <?php $i++; } ?>
                  </tbody>
                </table>
...
<script type="text/javascript">
    ...
    submitHandler: function() {
      ...
      $.ajax({
                url: '<?php echo base_url(); ?>branch/Product_Master/Manage_unit', 
                type: 'POST',
                dataType: 'json', 
                data: formData,
                contentType: false,
  ...
  function deleteunit(id)
  {
    ...
    var formData={"id":id};
    $.ajax({
      url:'<?php echo base_url('branch/Product_Master/Delete_unit'); ?>',
      type:'POST',
      dataType:'json',
      data: formData,
  ...
  function editunit(id)
  {
    ...
    $.ajax({
      type:'POST',
      url:'<?php echo base_url('branch/Product_Master/edit_unit'); ?>',
      dataType:'json',
      data:formData,
      success:function(data){
        //alert(resp);
