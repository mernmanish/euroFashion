...
<div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Slider List <a href="<?php echo base_url(); ?>branch/Website_setting/slider?do=new" class="btn btn-success" style="float: right;">Add New Slider</a></h1>
          </div>
        </div> 
      </div>
    </section>
                   ...
                   ?>
                    <tr>
                     ...
                     <?php } else { ?>
                      ...
                      <td>
		               <a  class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>branch/Website_setting/slider?do=update&id=<?php echo $rows['id']; ?>"><i class="fa fa-pencil"></i></a>
		              <button class="btn btn-success btn-sm" id="<?php echo $rows['id']; ?>" onclick="deleteslider(this.id)"><i class="fa fa-trash"></i></button></td>
                    </tr>
                  <?php $i++; } ?>
                  </tbody>
                </table>
...
<?php else: ?>
	<div class="content-wrapper">
     <section class="content-header">
      <h1>Add/Update Slider <a href="<?php echo base_url(); ?>branch/Website_setting/slider" class="btn btn-success pull-right">Slider List</a></h1>
    </section>
    <section class="content">
      <div class="container-fluid">
        <div class="row">
...
<script type="text/javascript">
    ...
    submitHandler: function() {
      ...
      $.ajax({
                url: '<?php echo base_url(); ?>branch/Website_setting/manageslider', 
                type: 'POST',
                dataType: 'json', 
                data: formData,
                contentType: false,
  ...
  function deleteslider(id)
  {
    ...
    var formData={"id":id};
    $.ajax({
      url:'<?php echo base_url('branch/Website_setting/deleteslider'); ?>',
      type:'POST',
      dataType:'json',
      data: formData,
    ...
    var abc=status;
     ...
     else
     {
      ...
      var formdata={'id':id,'status':status};
       $.ajax({
          url: '<?php echo base_url('branch/Website_setting/changsliderstatus'); ?>',
          type: 'POST',
          dataType: 'json',
          data: formdata,
          success:function(data){
