              ...
              <form role="form" id="cpform" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="password" class="form-control" id="password" name="password" placeholder="Enter Password" autocomplete="off" value="<?php echo $this->session->userdata('sessionuser')['password'] ?>" readonly>
                  </div>
                </div>
                <div class="row">
                  <div class="form-group col-md-6">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    submitHandler: function() {
      ...
      $.ajax({
                url: '<?php echo base_url(); ?>branch/Auth/change_userpassword', 
                type: 'POST',
                dataType: 'json', 
                data: formData,
                contentType: false,
