...
<div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Product List <a href="<?php echo base_url(); ?>vendor/Product?do=new" class="btn btn-success" style="float: right;">Add New Product</a></h1>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <table class="table table-bordered" id="table">
                  ...
                  <?php
                  $sqlproduct=$this->db->select('*')->from('product')->where('vendor_id',$this->session->userdata('sessionuser')['userid'])->order_by('id','desc')->get()->result_array();
                  $i=1;
                  foreach($sqlproduct as $rows)
                  {
                    ...
                    <?php } ?>
                     ...
                     <!--  <td><?php echo $rows['pricerange']; ?></td> -->
                      ...
                      <td>
                   <a  class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>vendor/Product?do=update&id=<?php echo $rows['id']; ?>"><i class="fa fa-pencil"></i></a>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12 col-12">
            <h1>Manage Product  <a href="<?php echo base_url(); ?>vendor/Product" class="btn btn-success pull-right">Product List</a></h1>
          </div>
        </div> 
      </div>
    </section>
...
<script type="text/javascript">
  function changestocktatus(pro_id)
  {
    ...
    $.ajax({
      url:'<?php echo base_url('vendor/Product/changestocktatus'); ?>',
      type:'POST',
      dataType:'json',
      data: formData,
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    submitHandler: function() {
      ...
      $.ajax({
                url: '<?php echo base_url(); ?>vendor/Product/manage_product', 
                type: 'POST',
                dataType: 'json', 
                data: formData,
                contentType: false,
  ...
  function deleteproduct(id)
  {
    ...
    var formData={"id":id};
    $.ajax({
      url:'<?php echo base_url('vendor/Product/delete_product'); ?>',
      type:'POST',
      dataType:'json',
      data: formData,
    success:function(data)
...
<script type="text/javascript">
    $(document).on('change','.unitdata',function(event){
      ...
      {
       $.ajax({
        url:"<?php echo base_url(); ?>vendor/Product/change_product",
        method:"POST",
  ...
  function filter_product()
   {
      ...
      $.ajax({
        type: 'POST',
        url: '<?php echo base_url() ?>vendor/Product/filter_product',
        dataType: 'json',
        data: formData,
        success:function(data){
          //alert(data);
