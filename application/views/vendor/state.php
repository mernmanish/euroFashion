...
<div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>State List <a href="<?php echo base_url(); ?>branch/Location_master/state?do=new" class="btn btn-success" style="float: right;">Add New State</a></h1>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <table class="table table-bordered" id="table">
                  ...
                  <?php
                  $sqluser=$this->db->select('*')->from('state')->where('branch_id',$this->session->userdata('sessionuser')['userid'])->order_by('id','DESC')->get()->result_array();
                  $i=1;
                   ...
                   ?>
                    <tr>
                     ...
                     <?php } else { ?>
                      ...
                      <td>
		               <a  class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>branch/Location_master/state?do=update&id=<?php echo $rows['id']; ?>"><i class="fa fa-pencil"></i></a>
		              <button class="btn btn-success btn-sm" id="<?php echo $rows['id']; ?>" onclick="deletestate(this.id)"><i class="fa fa-trash"></i></button></td>
                    </tr>
                  <?php $i++; } ?>
                  </tbody>
                </table>
...
<?php else: ?>
	<div class="content-wrapper">
     <section class="content-header">
      <h1>Add/Update State <a href="<?php echo base_url(); ?>branch/Location_master/state" class="btn btn-success pull-right">State List</a></h1>
    </section>
    <section class="content">
      <div class="container-fluid">
        <div class="row">
...
<script type="text/javascript">
    ...
    submitHandler: function() {
      ...
      $.ajax({
                url: '<?php echo base_url(); ?>branch/Location_master/managestate', 
                type: 'POST',
                dataType: 'json', 
                data: formData,
                contentType: false,
  ...
  function deletestate(id)
  {
    ...
    var formData={"id":id};
    $.ajax({
      url:'<?php echo base_url('branch/Location_master/deletestate'); ?>',
      type:'POST',
      dataType:'json',
      data: formData,
