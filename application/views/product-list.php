    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-4">
                ...
                <form class="price__filter--form" id="filterproduct" method="post"> 
                    <div class="single__widget widget__bg">
                        ...
                        ?>
                            <li class="widget__form--check__list">
                                <label class="widget__form--check__label" for="<?php echo $rows['id']; ?>"><?php echo $rows['name']; ?></label>
                                <input class="widget__form--check__input" id="<?php echo $rows['id']; ?>" value="<?php echo $rows['id']; ?>" type="checkbox" name="category_id[]">
                    ...
                    <div class="tab_content">
                        <div id="product_grid" class="tab_pane active show">
                            <div class="product__section--inner product__grid--inner">
                                <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-3 row-cols-2 mb--n30 productfilterresult">
                                <?php
...
<!-- <script type="text/javascript">
    function filtercollege(id){
        //alert(id);
        $.ajax({
            url:'<?php echo base_url() ?>Product/filterproduct',
            type: 'POST', 
            dataType: 'json', 
            data: {"category_id":id},
            contentType: false,
...
<script type="text/javascript">
   $(document).ready(function(){
       $(document).on('change','input[type=checkbox]',function(){
        //alert('hello');
      var formData=new FormData($('#filterproduct')[0]);
        $.ajax({
            url:'<?php echo base_url() ?>Product/filterproduct',
            type: 'POST', 
            dataType: 'html', 
