...
<div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>City List <a href="<?php echo base_url(); ?>cp/Location_master/city?do=new" class="btn btn-success" style="float: right;">Add New City</a></h1>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <table class="table table-bordered" id="table">
                  ...
                  <?php
                  $sqluser=$this->db->select('city.*,state.name as statename')->from('city')->join('state','state.id=city.state_id')->order_by('id','DESC')->get()->result_array();
                  $i=1;
                   ...
                   ?>
                    <tr>
                     ...
                     <?php } else { ?>
                      ...
                      <td>
		               <a  class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>cp/Location_master/city?do=update&id=<?php echo $rows['id']; ?>"><i class="fa fa-pencil"></i></a>
		              <button class="btn btn-danger btn-sm" id="<?php echo $rows['id']; ?>" onclick="deletecity(this.id)"><i class="fa fa-trash"></i></button></td>
                    </tr>
                  <?php $i++; } ?>
                  </tbody>
                </table>
...
<?php else: ?>
	<div class="content-wrapper">
     <section class="content-header">
      <h1>Add/Update City <a href="<?php echo base_url(); ?>cp/Location_master/city" class="btn btn-success pull-right">City List</a></h1>
    </section>
    <section class="content">
      <div class="container-fluid">
        <div class="row">
...
<script type="text/javascript">
    ...
    submitHandler: function() {
      ...
      $.ajax({
                url: '<?php echo base_url(); ?>cp/Location_master/managecity', 
                type: 'POST',
                dataType: 'json', 
                data: formData,
                contentType: false,
  ...
  function deletecity(id)
  {
    ...
    var formData={"id":id};
    $.ajax({
      url:'<?php echo base_url('cp/Location_master/deletecity'); ?>',
      type:'POST',
      dataType:'json',
      data: formData,
