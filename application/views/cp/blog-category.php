...
<div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Add/Update Blog Category</h1>
          </div>
        </div> 
      </div>
    </section>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table class="table table-bordered" id="table">
                  ...
                  <?php $sqlcat=$this->db->select('*')->from('blog_category')->get()->result_array();
                  $i=1;
...
<script type="text/javascript">
    ...
    submitHandler: function() {
      ...
      if($.inArray(ext, ['png','jpg','jpeg','gif','']) == -1) {
        ...
        $('.icon-error').fadeOut(6000);
     }
     else{
       var formData = new FormData($('#categoryform')[0]);
      $.ajax({
                url: '<?php echo base_url(); ?>cp/Blog/managenewscategory', 
                type: 'POST',
                dataType: 'json', 
                data: formData,
                contentType: false,
  ...
  function deletecategory(id)
  {
    ...
    var formData={"id":id};
    $.ajax({
      url:'<?php echo base_url('cp/Blog/deletecategory'); ?>',
      type:'POST',
      dataType:'json',
      data: formData,
  ...
  function editcategory(id)
  {
    ...
    $.ajax({
      type:'POST',
      url:'<?php echo base_url('cp/Blog/editcategory'); ?>',
      dataType:'json',
      data:formData,
      success:function(data){
        //alert(resp);
