...
<div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1>Admin List <a href="<?php echo base_url(); ?>cp/Auth/admin?do=new" class="btn btn-success" style="float: right;">Add New Admin</a></h1>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <table class="table table-bordered" id="table">
                  ...
                  <?php
                  $sqluser=$this->db->select('*')->from('users')->where('usertype','admin')->order_by('id','DESC')->get()->result_array();
                  $i=1;
                  foreach($sqluser as $rows)
                  {
                   ?>
                    <tr>
                      ...
                      <td>
		               <a  class="btn btn-warning btn-sm" href="<?php echo base_url(); ?>cp/Auth/admin?do=update&id=<?php echo $rows['id']; ?>"><i class="fa fa-pencil"></i></a>
...
<?php else: ?>
	<div class="content-wrapper">
     <section class="content-header">
      <h1>Add/Update Admin <a href="<?php echo base_url(); ?>cp/Auth/admin" class="btn btn-success pull-right">Admin List</a></h1>
    </section>
    <section class="content">
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="card card-danger">
              ...
              <form role="form" id="userform" method="post">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" name="aadhar_no" id="aadhar_no" class="form-control numonly" placeholder="Enter Aadhar Number" autocomplete="off" maxlength="12" value="<?php echo $sqledit[0]['aadhar_no']; ?>">
                  </div>
                  <div class="form-group col-md-3">
                    <label for="password">Password</label>
                    <input type="password" name="password" id="password" class="form-control" placeholder="Enter Password" autocomplete="off" value="<?php echo($sqledit[0]['password']); ?>">
                  </div>
                  <div class="form-group col-md-3">
                    <label for="confirmpassword">Confirm Password</label>
                    <input type="password" name="confirmpassword" id="confirmpassword" class="form-control" placeholder="Enter Confirm Password" value="<?php echo($sqledit[0]['password']); ?>">
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
              ...
              <form role="form" id="userform" method="post">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-md-3">
                    <label for="aadhar_no">Aadhar No</label>
                    <input type="text" name="aadhar_no" id="aadhar_no" class="form-control numonly" placeholder="Enter Aadhar Number" autocomplete="off" maxlength="12">
                  </div>
                  <div class="form-group col-md-3">
                  	<label for="password">Password</label>
...
<script type="text/javascript">
    ...
    submitHandler: function() {
      ...
      $.ajax({
                url: '<?php echo base_url(); ?>cp/Auth/insertadmin', 
                type: 'POST',
                dataType: 'json', 
                data: formData,
                contentType: false,
            ...
            .done(function(data) {
               ...
               $('.alert').show().addClass('alert-danger').text("New User Created Successfully");
                $('.alert').fadeOut(6000);
                ...
                $('.alert').fadeOut(6000); 
                 ...
                 $('.table').load(location.href + " .table");
                $('.alert').show().addClass('alert-success').text("User Updated Successfully");
                $('.alert').fadeOut(6000);
...
<script type="text/javascript">
  function changeadminstatus(id,status)
  {
     ...
     else
     {
      ...
      if(confirm("Are you Sure to "+d+" this Admin Status ?")){
      var formdata={'id':id,'status':status};
       $.ajax({
         ...
         {
          $('.table').load(location.href + " .table");
          $('.alert').show().addClass('alert-success').text("Admin status Successfully "+d);
              $('.alert').fadeOut(3000);
         }
        else
        {
