                  ...
                  foreach($sqlsize as $rows)
                  {
                   ?>
                    <tr>
		              ...
		              <button class="btn btn-danger" id="<?php echo $rows['id']; ?>" onclick="deletesize(this.id)"><i class="fa fa-trash"></i></button></td>
                    </tr>
                  <?php $i++; } ?>
                  </tbody>
                </table>
...
<script type="text/javascript">
    ...
    submitHandler: function() {
      ...
      $.ajax({
                url: '<?php echo base_url(); ?>cp/Product_Master/Manage_size',
                type: 'POST',
                dataType: 'json', 
                data: formData,
                contentType: false,
  ...
  function deletesize(id)
  {
    ...
    var formData={"id":id};
    $.ajax({
      url:'<?php echo base_url('cp/Product_Master/Delete_size'); ?>',
      type:'POST',
      dataType:'json',
      data: formData,
  ...
  function editsize(id)
  {
    ...
    $.ajax({
      type:'POST',
      url:'<?php echo base_url('cp/Product_Master/edit_size'); ?>',
      dataType:'json',
      data:formData,
      success:function(data){
        //alert(resp);
