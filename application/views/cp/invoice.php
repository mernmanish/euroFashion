                ...
                <div class="col-4 tcount pull-right">
                  <div class="table-responsive">
                    ...
                    <table class="table">
                      ...
                      <?php 
                      if(!empty($sqlinvoice[0]['wallet_amount']))
                      {
                      ?>
                      <tr>
                        <th style="width:65%">Wallet Discount :</th>
                        <td id="waamount"><i class="fa fa-inr"></i> <?php echo $sqlinvoice[0]['wallet_amount']; ?>.00 /-</td>
                        <input type="hidden" id="waamounts" value="<?php echo $sqlinvoice[0]['wallet_amount']; ?>">
                      </tr>
                      <?php } ?>
                      <?php 
                      if(!empty($sqlinvoice[0]['coupan_amount']))
                      {
                      ?>
                      <tr>
                        <th style="width:65%">Coupan Discount :</th>
                        <td id="caamount"><i class="fa fa-inr"></i> <?php echo $sqlinvoice[0]['coupan_amount'];  ?>.00 /-</td>
                        
                      </tr>
                      <?php } ?>
                      <?php 
                      if(!empty($sqlinvoice[0]['coupan_amount']) || !empty($sqlinvoice[0]['wallet_amount']))
                      {
                      ?>
                      <tr>
                        <th style="width:65%">Gross Amount :</th>
                        <td id="gaamount"></td>
                      </tr>
                      <?php } ?>
                    </tbody>
