                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <select name="vendor_id" id="vendor_id" class="form-control">
                      ...
                      <?php 
                      $branch=$this->db->select('*')->from('vendor')->get()->result_array();
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table class="table table-bordered" id="table">
                  ...
                  <?php $sqlcat=$this->db->select('*')->from('coupan')->order_by('id','DESC')->get()->result_array();
                  $i=1;
...
<script type="text/javascript">
    ...
    submitHandler: function() {
      ...
      $.ajax({
                url: '<?php echo base_url(); ?>cp/Product_Master/managecoupan', 
                type: 'POST',
                dataType: 'json', 
                data: formData,
                contentType: false,
  ...
  function deletecoupan(id)
  {
    ...
    var formData={"id":id};
    $.ajax({
      url:'<?php echo base_url('cp/Product_Master/deletecoupan'); ?>',
      type:'POST',
      dataType:'json',
      data: formData,
  ...
  function editcoupan(id)
  {
    ...
    $.ajax({
      type:'POST',
      url:'<?php echo base_url('cp/Product_Master/editcoupan'); ?>',
      dataType:'json',
      data:formData,
      success:function(data){
        //alert(resp);
        $('#coupanid').val(data.data.id);
        $('#vendor_id').val(data.data.vendor_id);
