...
class Order extends CI_Controller
{
   ...
   {
   	$this->load->view('vendor/order-list');
   }
   ...
   {
   	$this->load->view('vendor/bulk-order');
   }
   ...
   {
   	$this->load->view('vendor/bulk-product');
   }
   ...
   {
   	$this->load->view('vendor/invoice');
   }
   public function change_order()
   {
    $this->load->view('vendor/change-order');
   }
