                    ...
                    <div class="col-lg-8">
                        <div class="cart__table">
                            ...
                            <div class="continue__shopping d-flex justify-content-between">
                                <a class="continue__shopping--link" href="productlist.php">Continue shopping</a>
                        ...
                        <div class="cart__summary border-radius-10">
                            ...
                            <div class="cart__summary--footer">
                                ...
                                <ul class="d-flex justify-content-between">
                                    ...
                                    <li><a class="cart__summary--footer__btn primary__btn checkout" href="check-out.php">Check Out</a></li>
                                </ul>
                            </div>
                        </div> 
                    </div>
